			...
			<div class="box">
				...
				<div class="row">
					<div class="col-md-6 ml-auto">
						...
						<a href="CustomerListProductController"> Shop Now </a>
					</div>
				</div>
			</div>
		</div>
			...
			<div class="row">
						...
						<div class="contact_link_box">
							<a href=""> <i class="fa fa-map-marker" aria-hidden="true"></i>
								<span> Location </span>
									...
									Call +91 6352112547 </span>
							</a> <a href=""> <i class="fa fa-envelope" aria-hidden="true"></i>
								<span> ajayrajnadar@gmail.com </span>
							</a>
						</div>
					</div>
				</div>
				<div class="col-md-4 footer-col">
					<div class="footer_detail">
						<a href="index.html" class="footer-logo"> E-Appliances </a>
						<p>Our Company E-Appliances give the best and quality product.
						our customer were also satisfied by our service.</p>
				...
				<div class="col-lg-7 mx-auto px-0">
					<p>
						&copy; <span id="displayYear"></span> All Rights Reserved By <a
							href="MainHome.jsp">Ajayraj Nadar : -190670107067</a>
					</p>
				</div>
			</div>
		</div>
